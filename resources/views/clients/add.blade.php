            ...
            <div class="col-lg-8">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input value="{{old('matricule_fiscale')}}" name="matricule_fiscale" type="text" id="product-tname" class="form-control" placeholder="e.g : 1234567AAA000">
                    </div>


                    <div class="form-group mb-3">
                        <label for="product-name">Brand Name <span class="text-danger">*</span></label>
                        <input value="{{old('nom')}}" name="nom" type="text" id="product-name" class="form-control" placeholder="e.g : Webradar TN">
                    </div>

                    <div class="form-group mb-3">
                        <label for="product-sss">Source Client <span class="text-danger">*</span></label>
                        <input value="{{old('source_client')}}" name="source_client" type="text" id="product-sss" class="form-control" placeholder="e.g : Facebook">
                    </div>

                    <div class="form-group mb-3">
                        <label for="product-treference">Vis a Vis <span class="text-danger">*</span></label>
                        <input value="{{old('vis_a_vis')}}" name="vis_a_vis" type="text" id="product-treference" class="form-control" placeholder="e.g : Mr John Smith">
                    </div>

                    <div class="form-group mb-3">
                        <label for="product-yreference">Email <span class="text-danger">*</span></label>
                        <input value="{{old('email')}}" type="text" name="email" id="product-yreference" class="form-control" placeholder="e.g : john@wr.me">
                    </div>

                    <div class="form-group mb-3">
                        <label for="product-price">Phone Number <span class="text-danger">*</span></label>
                        <input value="{{old('telephone')}}" name="telephone" type="text" class="form-control" id="product-price" placeholder="Enter Phone">
                    </div>

                    <div class="form-group mb-3">
                        <label class="mb-2" for="address">Address <span class="text-danger">*</span></label>
                        <textarea class="form-control" name="adresse" id="address" cols="30" rows="5" style="resize: none;">{{old('adresse')}}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio form-check-inline">
                            <input type="radio" id="inlineRadio1" value="Prospect" name="etat" checked="">
                            <label for="inlineRadio1"> Prospect </label>
                        </div>
                        <div class="radio form-check-inline">
                            <input type="radio" id="inlineRadio2" value="Client" name="etat">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center mb-3">
                                ...
                                <button type="submit" class="btn w-sm btn-success waves-effect waves-light">Add</button>
                            </div>
                        </div> <!-- end col -->
                    </div>
                </div> <!-- end card-box -->
